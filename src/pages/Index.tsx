          ...
          <div className="grid md:grid-cols-3 gap-6 mb-16">
            <div className="text-center p-6 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-lg">
              <div className="text-3xl font-bold text-blue-600 mb-2">
                <AnimatedNumber value={300} suffix="+" duration={1200} startOnMount={false} />
              </div>
            ...
            <div className="text-center p-6 bg-gradient-to-br from-indigo-50 to-purple-50 rounded-lg">
              <div className="text-3xl font-bold text-indigo-600 mb-2">
                <AnimatedNumber value={9.0} suffix="" duration={1000} startOnMount={false} />
              </div>
              <div className="text-slate-600">CGPA</div>
            </div>
            <div className="text-center p-6 bg-gradient-to-br from-purple-50 to-pink-50 rounded-lg">
              <div className="text-3xl font-bold text-purple-600 mb-2">
                <AnimatedNumber value={12} suffix="+" duration={800} startOnMount={false} />
              </div>
